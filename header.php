...
<body>
	...
	<div id="container">
    	<div id="header">
            ...
            <div id="info">
                ...
                Selamat Datang <?php echo @$_SESSION['mysesi'] ?><br>
                 <center><a href="pages/logout.php" onClick='return confirm("Apakah Ada yakin akan keluar?")'>Keluar</a></center>
            </div>
            <div class="clear"></div>
        </div>
    </div>
        <div id="menu">
        <ul>
            <li class="utama"><a class="left" href="pages/home.php"><img src="images/home.png">Home</a></li>
             <?php 
            if(@$_SESSION['mytype']=='kepala_sekolah'){  ?>
            <li class="utama"><a class="center" href="pages/register.php"><img src="images/menu1.png">register</a></li>
            <?php
            }
            ?> 
            <?php 
            if(@$_SESSION['mytype']=='admin'){  ?>
            <li class="utama"><a class="center" href="pages/datasiswa.php"><img src="images/menu5.png">Data Siswa</a></li>
            <li class="utama"><a class="center" href="pages/pembayaran.php"><img src="images/menu5.png">Pembayaran</a></li>
            <?php
            }
            ?>
        ...
        <ul>
            <li><a class="utama center" href="pages/laporan_p.php"><img src="images/menu2.png">pembayaran</a></li>
