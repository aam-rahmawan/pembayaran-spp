 ...
 <div id="content">
            ...
            if($_SESSION['mytype']=='admin'){  ?>
                        <div id="body">
                            ...
                            <center><div class="title"><big>DATA SISWA</big></div></center>
...
<tr>
    ...
    <td width=100"px" align="center">
     <a href="update.php?id=<?php echo $data['id'] ?>"><img src="../images/edit.png"></a> ||
   <a href="datasiswa.php?id=<?php echo $data['id']; ?>" onClick='return confirm("Apakah Ada yakin menghapus?")'><img src="../images/delete.png"></a>
  </td>
</tr>
<?php
$no++;
...
<a href="datatabel.php" name="lihat">Tambah</a></td>
<?php
    } else{
